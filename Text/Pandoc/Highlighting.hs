{-
Copyright (C) 2008-2013 John MacFarlane <jgm@berkeley.edu>
...
{- |
   ...
   Copyright   : Copyright (C) 2008-13 John MacFarlane
...
highlight formatter (_, classes, keyvals) rawCode =
  let firstNum = case readMay (fromMaybe "1" $ lookup "startFrom" keyvals) of
                      Just n  -> n
                      Nothing -> 1
